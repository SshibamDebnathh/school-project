...
function Navbar() {
    ...
    return (
        <>
            {sidebar && (<ul className={'w-3/4 right-0 top-20 backdrop-blur-sm bg-slate-600 visible sm:hidden min-h-screen absolute flex flex-col space-y-10 font-medium items-center justify-center z-10 text-white rounded-md text-2xl'} onClick={(e) => {
            ...
            <nav
                ...
                <Menu className={'min-w-10 min-h-8 sm:hidden right-5 sticky top-6 text-white'} onClick={() => { setSidebar(!sidebar) }} />
